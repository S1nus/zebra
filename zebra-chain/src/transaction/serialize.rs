    ...
    fn zcash_serialize<W: io::Write>(&self, mut writer: W) -> Result<(), io::Error> {
        ...
        match self {
            ...
            Transaction::V7 {
                ...
                // Transaction V7 spec:
                // Similar to V6 but with Tachyon shielded data support
                ...
                // A bundle of fields denoted in the spec as `nTachygrams`, `nActions`,
                // `vActions`, `valueBalance`, `bindingSig`, `anchor`, `vTachygrams`, and `proof`.
                tachyon_shielded_data.zcash_serialize(&mut writer)?;
            }
        }
        Ok(())
